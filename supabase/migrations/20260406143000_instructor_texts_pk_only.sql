-- Lehrer-Anzeige auf PKW bereinigen (idempotent). Zeitstempel nach 20260406140000,
-- damit `db push --linked` ohne --include-all funktioniert (keine „Lücke“ in der Historie).
