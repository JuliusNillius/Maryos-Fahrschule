...
insert into public.site_settings (key, value) values
  ...
  ('stats', '{"googleRating":5,"googleReviews":18,"languages":10,"classes":6}'::jsonb),
...
-- Seed Fahrlehrer (Startdaten aus bisherigem Code)
insert into public.instructors (name, title, languages, classes, specialty, tags, quote, available, image, sort_order) values
  ('Maryo A.', 'Inhaber', '{de,ar,en}', '{B,BE,A}', 'Prüfungscoach', '{Geduldig,Erfahren,Motivierend}', 'Ich bringe dich sicher ans Ziel.', true, 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&h=500&fit=crop', 0),
  ('Anna K.', 'Angst-Expertin', '{de,ru}', '{B,AM}', 'Angst-Expertin', '{Einfühlsam,Ruhig,Strukturiert}', 'Gemeinsam schaffen wir das.', true, 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=500&fit=crop', 1),
  ('Can T.', 'Motorrad-Spezialist', '{de,tr,en}', '{B,A1,A2,A}', 'Motorrad-Spezialist', '{Leidenschaftlich,Präzise,Humorvoll}', 'Motorrad ist Freiheit — ich zeige dir wie.', true, 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=500&fit=crop', 2),
  ('Elena V.', 'Automatik-Expertin', '{de,ru}', '{B,BE}', 'Automatik-Expertin', '{Professionell,Freundlich,Geduldig}', 'Automatik ist die Zukunft.', false, 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&h=500&fit=crop', 3),
  ('Ahmad M.', 'Neueinsteiger-Coach', '{de,ar,fr}', '{B,AM,A1}', 'Neueinsteiger-Coach', '{Verständnisvoll,Locker,Unterstützend}', 'Jeder fängt mal an — ich bin dabei.', true, 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=500&fit=crop', 4);
...
-- Seed Fuhrpark (nur wenn Tabelle leer)
