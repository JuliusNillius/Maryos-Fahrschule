          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                />
                {form.image && (
                  <div className="relative mt-2 aspect-[3/4] w-full max-w-[240px] overflow-hidden rounded-lg bg-white/10">
                    <Image src={form.image} alt="" fill className="object-cover" sizes="240px" />
                  </div>
                )}
              </div>
              <div>
