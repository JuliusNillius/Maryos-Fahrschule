...
/** WhatsApp + Termin + Blitzer — mobil nur auf der Startseite, ab md überall. */
export default function FloatingActions() {
  ...
  return (
    <div
      className={`fixed top-20 right-4 z-50 flex flex-col gap-3 md:right-6 ${!isHome ? 'max-md:hidden' : ''}`}
    >
      {waReady && (
